...
# App Title
st.title("🎯 Customer Data Platform Dashboard")
...
with tab1:
    ...
    with input_col2:
        st.markdown("#### 📅 Customer Timeline & Engagement")
...
# ============================
with tab3:
    st.header("ℹ️ About This Customer Data Platform")
...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown("Made with ❤️ using Streamlit + .py + .ipynb by Devahuti")
